                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="my-3">
                                        <table class="table table-boardhead">
                                            <tr>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <form method="post">
                                        <div class="form-group">
                                            ...
                                            <input type="Password" name="old_pass" class="form_control"autocomplete="off"placeholder="Enter Old Password">
                                        </div>
                                        <div class="form-group">
                                            <label>New Password</label>
                                            <input type="Password" name="new_pass" class="form_control"autocomplete="off"placeholder="Enter New Password">
                                        </div>
                                        <div class="form-group">
                                            <label>Confirm Password</label>
                                            <input type="Password" name="con_pass" class="form_control"autocomplete="off"placeholder="Enter Confirm Password">
                                        </div>
